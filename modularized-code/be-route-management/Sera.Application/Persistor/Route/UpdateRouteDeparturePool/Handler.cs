...
public class UpdateRouteDeparturePoolHandler : BaseHandler, IRequestHandler<UpdateRouteDeparturePoolBusRequest, IResultStatus>
{
	...
	public async Task<IResultStatus> Handle(
		UpdateRouteDeparturePoolBusRequest request,
	...
	)
	{
		...
		route.departurePoolId = data.departurePoolId;
		route.departurePoolCode = data.departurePoolCode;
		route.departurePoolName = data.departurePoolName;
