...
exports.CustomerContractEntityPrismaDao = void 0;
...
class CustomerContractEntityPrismaDao extends audit_class_1.AuditClass {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const customerContactItemTransactionData = yield this.prisma.$transaction((tx) => __awaiter(this, void 0, void 0, function* () {
                    this.prisma.$use((params, next) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (dataValues) {
                        ...
                        if (customerContractItems && customerContractItems.length >= 1) {
                            yield Promise.all(customerContractItems.map((customerContractItem) => __awaiter(this, void 0, void 0, function* () {
                                ...
                                let cContractItemDataValue = yield tx.customerContractItem.upsert({
                                    where: {
                                ...
                                cContractItemDataValue = _.omit(cContractItemDataValue, ["$action", "persistedDate"]);
...
exports.CustomerContractEntityPrismaDao = CustomerContractEntityPrismaDao;
//# sourceMappingURL=customer.contract.entity.prisma.dao.js.map